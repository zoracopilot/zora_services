...
const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {menuOpen && (
        <div className="lg:hidden max-h-[calc(100vh-var(--nav-h))] overflow-y-auto overscroll-contain bg-[rgba(252,251,255,0.96)] backdrop-blur-xl px-6 py-6 space-y-3 border-t border-violet-100 md:px-8 md:py-7">
          <Link
            to="/"
