          ...
          <div className="max-w-[760px]">
            <TextReveal>
              ...
              <h2 className="mt-4 max-w-[520px] text-3xl font-semibold leading-tight tracking-[-0.03em] text-slate-950 md:text-[2.55rem]">
               Comprehensive Business Solutions for Growth & Success
              
              </h2>
            </TextReveal>
            <TextReveal delay={0.08} className="mt-6 max-w-[760px] space-y-5 text-base leading-8 text-slate-600">
              <p>
                We help businesses grow their online presence, optimize marketing performance, and generate qualified leads through digital marketing services designed to deliver measurable results and long-term value. Our approach focuses on data-driven strategies that improve visibility, engagement, and conversions across digital channels.
              </p>
              <p>
               From SEO and performance marketing to social media and lead generation campaigns, our solutions are built around targeted execution, continuous optimization, and measurable growth. We help brands reach the right audience, maximize ROI, and make smarter marketing decisions at every stage.
              </p>
            </TextReveal>
          </div>
