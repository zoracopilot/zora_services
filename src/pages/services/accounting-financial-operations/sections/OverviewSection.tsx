      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,0.95fr)_420px] lg:items-start lg:gap-12">
        <div>
          <div className="max-w-[760px]">
            <TextReveal>
              ...
              Scalable Financial Operations Services
              
              </h2>
            </TextReveal>
            <TextReveal delay={0.08} className="mt-6 max-w-[760px] space-y-5 text-base leading-8 text-slate-600">
              <p>
               We provide accounting and financial operations services designed to help startups and growing businesses maintain accurate financial records, ensure compliance, and build a strong financial foundation. Our approach combines efficient bookkeeping, financial reporting, and process optimization to deliver reliable insights that support better decision-making and long-term stability.
              </p>
              <p>
                From financial planning to reporting and compliance, we focus on delivering secure, accurate, and scalable financial solutions tailored to your business needs. Whether it’s managing day-to-day accounting, optimizing cash flow, or supporting financial operations, our services are built to improve efficiency, reduce risk, and drive sustainable business growth.
              </p>
            </TextReveal>
          </div>
        ...
        <TextReveal delay={0.12} className="lg:sticky lg:top-36">
          <div className="overflow-hidden border border-slate-200 bg-slate-50 shadow-[0_16px_48px_rgba(15,23,42,0.08)]">
            <img
              src="/services/Accounting_financial_operations/overview.webp"
              alt="Accounting and financial operations overview"
