...
const content: any = {
  ...
  heroSubtitle:
    "Build fast, secure, and scalable websites that drive real business growth.",
    ...
    <section className="relative min-h-screen bg-[#050816] text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="rounded-[32px] overflow-hidden border border-white/10 bg-white/5 shadow-[0_30px_100px_rgba(37,99,235,0.12)] backdrop-blur-2xl">
            <div className="relative h-[420px] md:h-[500px] lg:h-[560px]">
              ...
              />
              <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(7,12,29,0.92)_0%,rgba(7,12,29,0.78)_32%,rgba(7,12,29,0.42)_62%,rgba(7,12,29,0.18)_100%)]" />
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(56,189,248,0.18),transparent_28%),radial-gradient(circle_at_72%_22%,rgba(168,85,247,0.16),transparent_24%),radial-gradient(circle_at_42%_78%,rgba(59,130,246,0.14),transparent_26%)]" />

              <div className="restore-hero absolute inset-0 flex items-start px-8 py-8 md:px-12 md:py-10 lg:px-16 lg:py-14">
                <div className="max-w-[560px] text-left">
                  <div className="mb-10 flex flex-wrap items-center gap-3 text-sm font-semibold text-white/90 md:mb-14">
                    <Link to="/services" className="transition hover:text-white">
                      Services
                    </Link>
                    <span className="text-white/60">&gt;</span>
                    <Link to={`/services/${category.slug}`} className="transition hover:text-white">
                      {category.title}
                    </Link>
                    <span className="text-white/60">&gt;</span>
                  ...
                  <h1 className="whitespace-pre-line text-3xl font-semibold leading-[1.3] tracking-[-0.03em] text-white md:text-4xl lg:text-[3.2rem]">
                  ...
                  <div className="mt-10 flex flex-wrap items-center gap-4">
                    <Link
                      to="/book-appointment"
                      className="inline-flex items-center gap-3 rounded-2xl bg-white px-6 py-4 text-base font-semibold text-slate-900 transition hover:bg-slate-100 md:px-7 md:py-4.5 md:text-lg"
                    >
                    ...
                    <a
                      href="#contact"
                      className="inline-flex items-center gap-2 rounded-2xl border border-white/20 bg-white/8 px-5 py-4 text-base font-semibold text-white transition hover:bg-white/14 md:text-lg"
                    >
      ...
      <div className="px-6 py-16">
        <div className="max-w-6xl mx-auto space-y-14">
              ...
              {(content?.projectDuration?.cards ?? []).map(
                (card: { title: string; label: string; desc: string }) => (
                  ...
                  >
                    ...
                    <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-blue-300/60 to-transparent" />
                    <div className="relative text-2xl md:text-3xl font-extrabold text-slate-900">
                      {card.title}
                    </div>
                    <div className="relative mt-3 text-sm font-semibold uppercase tracking-[0.14em] text-blue-200 transition-colors duration-300 group-hover:text-white group-active:text-white">
                      {card.label}
                    </div>
          ...
          <div className="restore-architecture rounded-[32px] bg-white/5 border border-white/10 p-8 md:p-10">
            <div className="text-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-[26px] border border-white/10 bg-[#0f1829] p-4 shadow-[0_6px_18px_rgba(59,130,246,0.14)]">
                      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4">
                        ...
                        <div className="pt-8 text-3xl text-blue-300">&rarr;</div>
                      ...
                      <div className="mt-0.5 text-center text-[28px] text-blue-300">&darr;</div>
                    </div>
                    ...
                    <div className="rounded-[26px] border border-white/10 bg-[#0f1829] p-4 shadow-[0_6px_18px_rgba(59,130,246,0.14)]">
                      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4">
                        ...
                        <div className="text-3xl text-blue-300">&rarr;</div>
          ...
          <div
            id="contact"
            className="restore-contact rounded-[32px] border border-white/10 bg-[linear-gradient(135deg,rgba(14,23,43,0.98),rgba(20,14,40,0.95))] p-8 md:p-10"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-blue-200">
