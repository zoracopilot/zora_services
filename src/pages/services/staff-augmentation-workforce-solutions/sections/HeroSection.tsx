    ...
    <section className="relative overflow-hidden border border-slate-200 shadow-[0_20px_60px_rgba(15,23,42,0.06)]">
      ...
      <div className="relative px-6 py-10 sm:px-8 lg:px-16 lg:py-14">
        <div className="max-w-[780px]">
          <TextReveal>
            <h1
              className="max-w-[760px] text-[2.7rem] font-semibold leading-[0.98] tracking-[-0.05em] !text-white sm:text-5xl lg:text-[4.2rem]"
              style={{ textShadow: "0 10px 30px rgba(15, 23, 42, 0.45)" }}
            >
              <span className="block whitespace-nowrap">Staff Augmentation &</span>
              <span className="block whitespace-nowrap">Workforce Solutions</span>
            </h1>
          </TextReveal>
          ...
          <TextReveal delay={0.1}>
            ...
            >
              We provide staff augmentation and workforce solutions to help organizations scale teams, enhance productivity, and support sustainable business growth.
            </p>
          </TextReveal>
