        ...
        <div>
          <div className="max-w-[760px]">
            ...
            <TextReveal delay={0.08} className="mt-6 max-w-[760px] space-y-5 text-base leading-8 text-slate-600">
              <p>
              We help organizations scale efficiently and overcome resource gaps through staff augmentation and workforce solutions designed for flexibility and performance.Our approach focuses on providing skilled talent, faster onboarding, and seamless integration with your existing teams.
              </p>
              <p>
               From identifying skill gaps to deploying qualified talent and managing performance, our approach ensures agile and scalable workforce solutions.We deliver staff augmentation services that enable faster execution, seamless collaboration, and improved business outcomes.
              </p>
            </TextReveal>
          </div>
