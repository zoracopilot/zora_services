...
export const websiteWebAppOverviewCards = [
  ...
  },
  {
    ...
    description:
      "Seamless cloud migration with minimal downtime, ensuring efficient and secure data transfer.",
  },
  {
    title: "DevOps & Automation",
    description:
      "Implement DevOps and automation to accelerate deployment and improve operational efficiency.",
  },
  {
    title: "Cloud Security & Compliance",
    description:
      "Advanced security solutions to protect data, ensure compliance, and maintain secure cloud environments.",
  },
] as const;
