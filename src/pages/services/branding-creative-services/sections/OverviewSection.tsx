      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,0.95fr)_420px] lg:items-start lg:gap-12">
          ...
          <div className="max-w-[760px]">
            <TextReveal>
              ...
              <h2 className="mt-4 max-w-[520px] text-3xl font-semibold leading-tight tracking-[-0.03em] text-slate-950 md:text-[2.55rem]">
               Strategic Business Solutions for Scalable Success
              </h2>
            </TextReveal>
            <TextReveal delay={0.08} className="mt-6 max-w-[760px] space-y-5 text-base leading-8 text-slate-600">
              <p>
               We craft branding and creative solutions that define your identity and position your business uniquely.Our approach helps differentiate your brand in competitive markets with impactful design and messaging.We create memorable customer experiences that strengthen engagement and long-term brand value.
              </p>
              <p>
                From brand strategy and visual design to marketing creatives and content storytelling, our approach focuses on consistency, creativity, and impact to drive recognition and growth.We align every creative element with your business goals to ensure a cohesive and powerful brand presence across all platforms.Our solutions enhance audience engagement, improve brand recall, and support long-term business success.
              </p>
            </TextReveal>
          </div>
        ...
        <TextReveal delay={0.12} className="lg:sticky lg:top-36">
          <div className="overflow-hidden border border-slate-200 bg-slate-50 shadow-[0_16px_48px_rgba(15,23,42,0.08)]">
            <img
              src="/services/Branding_creative/overview.webp"
              alt="Branding and creative services overview"
