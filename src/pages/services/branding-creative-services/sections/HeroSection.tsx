  ...
  return (
    <section className="relative overflow-hidden border border-slate-200 shadow-[0_20px_60px_rgba(15,23,42,0.06)]">
      <div
        ...
        style={{ backgroundImage: "url('/services/Branding_creative/hero.webp')" }}
      />
      ...
      <div className="relative px-6 py-10 sm:px-8 lg:px-16 lg:py-14">
        <div className="max-w-[620px]">
          ...
          <TextReveal delay={0.1}>
            ...
            >
              We provide branding and creative services to help businesses build a strong identity, engage audiences, and drive brand growth.
            </p>
          </TextReveal>
